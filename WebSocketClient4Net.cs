...
{
    public sealed class WebSocketClient4Net : IWebSocketClient
    {
        ...
        public WebSocketClient4Net(ILogger<WebSocketClient> logger = null)
        {
            _logger = logger;
        }
        ...
        private void WebSocket_DataReceived(object sender, DataReceivedEventArgs e)
        {
            ...
            sb.Append(Encoding.UTF8.GetString(e.Data));
